...
class DataParallelPPOActor(BasePPOActor):
    ...
    def _forward_micro_batch(
        ...
        Args:
            ...
            perturb_std: Standard deviation for logits perturbation (0.0 = no perturbation)
    ...
    def update_policy(self, data: DataProto):
        ...
        # Include rollout_log_probs if available (needed for perturbation)
            ...
            for batch_idx, mini_batch in enumerate(mini_batches):
                ...
                for micro_batch in micro_batches:
                    ...
                    if use_perturbation:
                        ...
                        # Get additional parameters for perturbation mode
                        turn_end_indicator = model_inputs.get("critic_response_mask", None)
                        void_turn_mask = model_inputs.get("void_turn_mask", None)
                        
                        # Use the perturbation-aware policy loss function
                        pg_loss, pg_clipfrac, ppo_kl, pg_clipfrac_lower, ppo_is_metrics = compute_policy_loss_perturbed(
                        ...
                        # Add IS metrics with 'actor/' prefix
