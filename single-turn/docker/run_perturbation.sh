#!/bin/bash
# --------------------------------------------------------
# Docker launcher for Perturbation experiment (8-GPU version)
...
echo "=========================================="
echo "Perturbation 实验 Docker 启动器"
echo "Loss Mode: ${LOSS_MODE}, Perturb Std: ${PERTURB_STD}"
echo "Geometric: ${GEOMETRIC}, Dataset: ${DATASET}"
...
docker run --rm \
    ...
    bash -c "
        ...
        bash run_exp_perturbation.sh ${LOSS_MODE} ${PERTURB_STD} ${GEOMETRIC} ${DATASET}
    "
