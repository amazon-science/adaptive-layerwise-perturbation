...
echo "=========================================="
echo "Experiment 1: MIS Baseline"
...
MODEL_BASE="Qwen" #"meta-llama"
MODEL_NAME="Qwen3-4B" #"Llama-3.2-3B-Instruct"

tis_level="sequence"
tis_mode="mask"
tis_threshold=2.0
tis_threshold_lower=0.0
veto_threshold=0.0
geometric=false
...
exp_name="mis_baseline_${tis_level}_${tis_mode}_${tis_threshold}_loss_${loss_mode}_${clip_ratio_low}_${clip_ratio_high}_${MODEL_NAME}_${dataset_name}_n${n_resp_per_prompt}_prompt_bsz_${train_prompt_bsz}_mini_bsz_${train_prompt_mini_bsz}"
